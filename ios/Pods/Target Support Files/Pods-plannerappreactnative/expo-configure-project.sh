...
with_node --no-warnings --eval "require('expo-modules-autolinking')(process.argv.slice(1))" generate-package-list  --target "/Users/rameshabeysekara/Documents/Fanshawe/Level_03/project/planner-app-react-native/ios/Pods/Target Support Files/Pods-plannerappreactnative/ExpoModulesProvider.swift"
